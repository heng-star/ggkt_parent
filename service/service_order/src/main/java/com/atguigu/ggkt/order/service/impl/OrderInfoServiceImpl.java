...
public class OrderInfoServiceImpl extends ServiceImpl<OrderInfoMapper, OrderInfo> implements OrderInfoService {
    ...
    @Override
    public  Map<String, Object> listorderpage(Page<OrderInfo> page,Integer userid) {

        int  useid=userid;
        QueryWrapper<OrderInfo> wrapper = new QueryWrapper<>();
        wrapper.eq("user_id",useid);
        Page<OrderInfo> pages = baseMapper.selectPage(page,wrapper);
//        //获取分页数据
